...
export default function Document() {
  ...
  function handleSearch() { 
    if (Object.values(articleSearch).every(value => !value) && Object.values(profileSearch).every(value => !value)) {
      setGroupedDocuments([])
      setProfiles([])
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-grow overflow-y-auto">
        ...
        {profiles.map((profile, index) => (
          <div key={index} className="mb-4 flex rounded-md bg-white p-4 shadow-md">
            {/* {profile.image && (
                <div className="w-1/4">
