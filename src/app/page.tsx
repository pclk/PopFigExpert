...
export const examplePrompts = {
  "📜Article summary of [xxx]": "Could you generate an article summary on xxx?",
  "🧑Profile summary of [xxx]": "Could you generate a profile summary on xxx?",
};
            ...
            <TabsContent value="chat">
              <Card className="shadow-none">
                <CardHeader>
                  ...
                  <div className="text-md  mt-0 flex flex-col whitespace-pre-line text-slate-500">
                    ...
                    <ul>
                      <li>
                        I can retrieve documents for you by writing a search
                        query.
                      </li>
                      <li>
                        I can also search a Wikipedia summary of popular
                        political figures.
                      </li>
                    </ul>
            ...
            <TabsContent value="search">
              <Card className="h-92 shadow-none">
                <CardHeader>
                  ...
                  <div className="text-md mt-0 whitespace-pre-line text-slate-500">
                    ...
                    If you would like to, you can visit the website here: `}
                    <a href="https://www.mfa.gov.sg/Newsroom/Press-Statements-Transcripts-and-Photos">
                      MFA Press
                    </a>
