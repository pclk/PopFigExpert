  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-darkprim text-white hover:bg-secondary hover:text-darkprim focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today: "",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-secondary aria-selected:text-slate-900 dark:aria-selected:bg-slate-800 dark:aria-selected:text-slate-50",
